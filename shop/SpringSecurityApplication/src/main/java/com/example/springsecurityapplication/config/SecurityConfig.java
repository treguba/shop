...
//                .antMatchers("/user").hasAnyRole("USER")
                ...
                .antMatchers("/auth/login", "/error", "/auth/registration","/order", "/product/info/{id}", "/product/search", "/product/search_a", "/product_adm/search","/product_user/search","/resources/**", "/static/**", "/js/**", "/img/**","/css/**","/login","/product", "/product_adm", "/product_user").permitAll()
