...
public class AdminController {
    ...
    @Autowired
    public AdminController(ProductValidator productValidator, ProductService productService, CategoryRepository categoryRepository, ProductRepository productRepository) {
...
//@PreAuthorize("hasRole('ROLE_ADMIN') or hasRole('')")
    ...
    public String admin(Model model){
        ...
        model.addAttribute("products", productService.getAllProductAdm());
        return "admin/admin";
    }
